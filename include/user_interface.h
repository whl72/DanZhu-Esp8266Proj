...
#define TT_MODE			0x05
#define UPDATA_MODE		0x06
#define WAIT_MODE		0x07
#define CBUPDATA_MODE	0x08
#define NET_RECONNECT   0x09
#define DELAY_MODE		0x0a
...
struct station_config {
    ...
    uint8 bssid[6];//原本官方的结构体
//    uint8 bssid[18];//为方便数据格式，自定义的
};
